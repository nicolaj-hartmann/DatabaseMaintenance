...
namespace DatabaseMaintenance
{
    public class DatabaseClient
    {
        ...
        public async Task ExecuteIndexOptimizeProcedure(IndexOptions options, Action<string> output = null, CancellationToken? cancellationToken = null)
        {
            ...
            await command.ExecuteNonQueryAsync(cancellationToken.Value);
        }
